...
void loop() {
  ...
  if (buttonA == 0 && (millis() - lastTime > 100) && bApressed == false && maxCount <= 10)
  { //start code
    maxCount++;
  ...
  //how much time before turn on the OUT solenoid
  ...
  //how much time before turn OFF the OUT solenoid
